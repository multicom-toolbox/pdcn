...
foreach $line (@array) 
{
	...
	else
	{
		...
		`perl $GLOBAL_PATH/scripts/blast_search_swiss_prot.pl $in/temp.fasta $GLOBAL_PATH/programs/blast-2.2.17/bin/blastpgp $in $out ../swiss_prot_2016/uniprot_sprot.fasta ../swiss_prot_2016/uniprot_sprot.dat $in/swiss_prot_euk_1.LOG ../swiss_prot_2016/uniprot_sprot.fasta`;
